...
export const projects: Project[] = [
  {
    ...
    consideration: [
      ...
      "문서 생성 단계는 원본을 정리하고 분류해 문서로 만드는 작업이라 비싼 모델이 필요하지 않다고 판단해, Extractor · Router · Merger 를 모두 경량 모델로 구성했습니다. 대신 작은 모델일수록 한 번에 주는 지시가 늘면 지시 준수율이 떨어지기 때문에, 에이전트마다 역할을 하나씩만 맡겨, 한 번에 판단해야 할 범위를 좁혔습니다.",
    ],
    diagram: "axel",
